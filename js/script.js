...
if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
        ...
        if (isEmailJSConfigured) {
            ...
            const emailSubject = encodeURIComponent(`Consultation request from Helix-Zain Website — ${serviceNeeded}`);
            ...
            const mailtoLink = `mailto:basilbasheermuhammad@gmail.com?subject=${emailSubject}&body=${emailBody}`;
            
            // Open email client
            window.location.href = mailtoLink;
            
            showNotification('Please configure EmailJS for automatic email sending. See EMAIL_SETUP.md for instructions. Opening your email client as fallback.', 'error');
